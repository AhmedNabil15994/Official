        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown d-lg-inline-block topbar-dropdown">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ DIRECTION == 'ltr' ? asset('assets/images/flags/us.jpg') : asset('assets/images/flags/ksa.png') }}" alt="user-image" height="16">
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item lang-item">
                        <img src="{{ asset('assets/images/flags/us.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">{{ trans('main.english') }}</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item lang-item">
                        <img src="{{ asset('assets/images/flags/ksa.png') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">{{ trans('main.arabic') }}</span>
                    </a>
