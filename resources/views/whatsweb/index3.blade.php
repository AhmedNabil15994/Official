        ...
        <div id="app">
          <div class="_1ADa8 app-wrapper-web font-fix">
            <div class="_1INL_ _2FX6G">
              ...
              <div class="_3iu7m">
                <div role="button" tabindex="0" class="_20C5O GObVX">
                  <div class="p357zi0d ktfrpxia nu7pwgvd ac2vgrno sap93d0t gndfcl4n">
                    <div class="tvf2evcx m0h2a7mj lb5m6g5c j7l1k36l ktfrpxia nu7pwgvd gjuq5ydh" data-testid="content">Log out</div>
                  </div>
                </div>
              </div>
              <div class="QgIWN">Don't close this window. Your messages are downloading.</div>
            </div>
          </div>
        </div>
